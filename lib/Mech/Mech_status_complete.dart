...
class MechStatusComplete extends StatefulWidget {
  const MechStatusComplete({super.key});

  @override
  State<MechStatusComplete> createState() => _MechStatusCompleteState();
}

class _MechStatusCompleteState extends State<MechStatusComplete> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Center(
        ...
        child: Center(child: Text("2000/-",style: TextStyle(fontWeight: FontWeight.bold),)),
        ),
      ),
          SizedBox(height: 40.h,),
          InkWell(
